...
import { BarResource, BarResourceType } from './music.js';
...
const BarClock = () => Widget.Box({
    ...
    children: [
        ...
        // Widget.Label({
        //     className: 'txt-norm txt-onPrimary',
        //     label: '•',
        // }),
        // Widget.Label({
...
const BarBattery = () => Box({
    ...
    children: [
        ...
        BarResource({
            ...
            percentageViewCommand: `sed -n 7p /dev/shm/system_stats`,
            totalViewCommand: `sed -n 8p /dev/shm/system_stats`,
        ...
        BarResource({
            ...
            icon: "arrow_upward",
            barResourceType: BarResourceType.Percentage_and_Total,
            percentageViewCommand: `sed -n 9p /dev/shm/system_stats`,
            totalViewCommand: `sed -n 10p /dev/shm/system_stats`,
            circprogClassName: "bar-ram-circprog",
            textClassName: "bar-ram-txt",
            iconClassName: "bar-ram-icon",
          }),
